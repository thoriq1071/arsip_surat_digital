          ...
          <div class="panel-heading text-left">
            <div class="row">
              <div class="col-sm-6 text-left">
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b class="">&nbsp; DETAIL SURAT KELUAR</b><br>Sistem Informasi Arsip Surat Digital
              </div>
            </div>
          </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <input type="text" name="no_surat" id="no_surat" value="<?php echo $query->status; ?>" class="form-control" placeholder="Masukkan Nomor Surat" readonly>
                    </div>
                  </div>
                </div>
