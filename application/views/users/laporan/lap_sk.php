          ...
          <div class="panel-heading text-left">
            <div class="row">
              <div class="col-sm-6 text-left">
                <i class="icon-printer"></i><b>&nbsp; FILTER DATA LAPORAN SURAT KELUAR</b><br>Sistem Informasi Arsip Surat Digital
              </div>
            </div>
          </div>
          <?php
            ...
            <fieldset class="content-group">
              <form class="form-horizontal text-center" action="" method="post">
                <div class="form-group">
                  ...
                  <button type="submit" name="data_lap" class="btn btn-primary text-right"><span class="glyphicon glyphicon-search"></span>&nbsp;<b> FILTER DATA</b></button>
                </div>
              </form>
            </fieldset>
          </div>
